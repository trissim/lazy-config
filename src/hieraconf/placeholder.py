...
class LazyDefaultPlaceholderService:
    ...
    def has_lazy_resolution(dataclass_type: type) -> bool:
        ...
        return hasattr(dataclass_type, "_resolve_field_value") and hasattr(
            dataclass_type, "to_base_config"
        )
    ...
    @staticmethod
    def _get_lazy_type_for_base(base_type: type) -> type | None:
    ...
    @staticmethod
    def _format_placeholder_text(resolved_value: Any, prefix: str) -> str | None:
