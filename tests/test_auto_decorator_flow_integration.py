"""Integration tests for decorator-driven workflow using import-time fixtures.

These tests import small fixture modules that perform the decorator/injection
flow at import time so the library's side effects (exporting Lazy classes,
